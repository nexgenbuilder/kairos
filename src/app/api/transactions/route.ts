...
export async function POST(req: Request) {
  ...
  const rows = await q`
    INSERT INTO transactions (user_id, type, amount, occurred_at, description, category, deal_id, prospect_id)
    VALUES (${user.id}, ${type}, ${amount}, ${occurredAt}, ${description}, ${category}, ${dealId}, ${prospectId})
